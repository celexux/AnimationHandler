...
public final class Constants {
  ...
  public static class LEDConstants {
    ...
    public static final int BLUE_H = 120;
    public static final int BLUE_S = 255;
    public static final int BLUE_V = 255;
    public static final int SHIFT_S = 255;
    public static final int SHIFT_V = 255;
  }
